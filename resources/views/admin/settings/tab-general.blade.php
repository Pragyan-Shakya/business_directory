<div class="tab-pane active" id="general">
    ...
    <div class="form-group{{ $errors->has('login-img') ? ' has-error' : '' }}">
        <label for="login-img" class="col-sm-2 control-label">Login Page Image</label>
        <div class="col-sm-10">
            <input type="file" name="login-img" id="login-img" class="form-control">
            @if ($errors->has('login-img'))
                <span class="help-block">
                    {{ $errors->first('login-img') }}
                </span>
            @endif

            @if(getConfiguration('login-img'))
                <div class="mt-15 half-width">
